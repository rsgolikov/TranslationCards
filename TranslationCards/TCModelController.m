...
@interface TCModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation TCModelController
...
{   
    ...
    TCDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"TCDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(TCDataViewController *)viewController];
